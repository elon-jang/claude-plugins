...
---
## AI Notes
- **Summary**: Claude Agent SDK를 사용해 내 Claude Code 토큰을 소모하면서 디자인을 합니다. 직접 앱을 뜯어봤습니다. Electron 앱이라 asar 파일을 추출해서 코드를 분석했어요. 그냥 디자인 도구가 아니라, Claude Code의 능력을 디자인 영역에 이식한 에이전트입니다.
- **Topics**: general